                    ...
                    users && users.length > 0 ?
                        searchedUsers.map((user) => (
                            <button
                                ...
                                className={`relative group w-full p-3 flex items-center gap-3 hover:bg-base-300 transition-colors ${selectedUser?._id === user._id ? 'bg-base-300 ring-1 ring-base-300' : ''}`}>
